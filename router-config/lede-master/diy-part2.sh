...
sed -i "s/root::0:0:99999:7:::/root:"'$'"1"'$'"itShnP4Q"'$'".BHxTSYPbx1sj5UZsZX441:0:0:99999:7:::/g" package/base-files/files/etc/shadow
...
# hsotname
sed -i "s/OpenWrt/Seino/g" package/base-files/files/bin/config_generate
